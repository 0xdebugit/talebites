            ...
            <div className='w-screen max-w-screen-sm story-board relative md:shadow-2xl md:shadow-sky-800/50'>
                <div className='grid grid-cols-1 gap-6'>
                    ...
                    <div className='text-center'>
                        <Link href={'/'}>
                            <button type="button" className="text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-sky-600 dark:hover:bg-sky-700 focus:outline-none dark:focus:ring-sky-800">Home</button>
                        </Link>
                    </div>
